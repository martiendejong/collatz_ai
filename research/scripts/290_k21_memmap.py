"""
290_k21_memmap.py - k=21, lambda=1.05 via disk-backed memmaps.
N = 3^20 = 3,486,784,401. Two float32 memmaps (13.9 GB each) on E:.
RAM use: cb (4.65 GB) + chunk buffers (~0.7 GB). Same peak as the k=19 run.
...
Purpose (Obs 489): extend direct verification past the predicted trough and
narrow the spectral fit family — dev(21) vs dev(20) discriminates slow-decay members.
"""
import numpy as np
import os
