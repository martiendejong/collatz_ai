...
at depths $k=13,15,17,19,20$ (up to $1{,}162{,}261{,}467$ constraints) and verify explicit
rational certificates in exact integer arithmetic, obtaining
\[
\pi_1(x)\;\ge\; x^{0.9146}\qquad\text{for all sufficiently large }x,
\]
with intermediate verified exponents $0.8624$, $0.8805$, $0.8953$, $0.9069$. No new mathematics is
...
$10^{18}$); comparisons are exact integer arithmetic. Zero violations at all five depths
($1.6\times 10^9$ constraints in total). Certificates and a standalone {\tt numpy}-only
