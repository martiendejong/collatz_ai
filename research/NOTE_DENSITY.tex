...
\title{Improved lower bounds for the $3x+1$ problem via the\\ Krasikov--Lagarias inequalities at depths $3^{13}$ through $3^{19}$}
...
\[
\pi_1(x)\;\ge\; x^{0.9069}\qquad\text{for all sufficiently large }x,
\]
...
Perron) iteration replaces the interior-point solver, making depth $3^{19}$ routine on a
...
19 & 387{,}420{,}489 & $15/8$ & $1.000939$ & $\mathbf{0.9069}$\\
\bottomrule
\end{tabular}
\end{center}

\begin{theorem}
$\pi_1(x)\ \ge\ x^{0.9069}$ for all sufficiently large $x$.
\end{theorem}
